...
<span class="token punctuation">}</span>
    ...
    <span class="token punctuation">}</span>
  <span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_12px缩小" tabindex="-1"><a class="header-anchor" href="#_12px缩小"><span>12px缩小</span></a></h2><div class="hint-container info"><p class="hint-container-title">12px缩小</p><p>1:利用transform的scale属性进行缩放</p><div class="language-css line-numbers-mode" data-ext="css" data-title="css"><pre class="language-css"><code>  <span class="token selector">p</span><span class="token punctuation">{</span>
  ...
  <span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>2:利用zoom缩放属性</p><div class="language-css line-numbers-mode" data-ext="css" data-title="css"><pre class="language-css"><code>  <span class="token selector">p</span><span class="token punctuation">{</span>
    <span class="token property">font-size</span><span class="token punctuation">:</span>12px<span class="token punctuation">;</span>
    <span class="token property">zoom</span><span class="token punctuation">:</span>0.5<span class="token punctuation">;</span>
  <span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>3:媒体查询@media</p><div class="language-css line-numbers-mode" data-ext="css" data-title="css"><pre class="language-css"><code>  <span class="token selector">p</span> <span class="token punctuation">{</span>
    <span class="token property">font-size</span><span class="token punctuation">:</span> 12px<span class="token punctuation">;</span> <span class="token comment">/* 默认字体大小 */</span>
  <span class="token punctuation">}</span>
...
- align-items
- align-content
</code></pre>`,20),d={href:"https://blog.csdn.net/qq_69183322/article/details/136102095",target:"_blank",rel:"noopener noreferrer"},u=a('<h2 id="flex-1" tabindex="-1"><a class="header-anchor" href="#flex-1"><span>flex:1</span></a></h2><h4 id="实际上相当于是flex-1-1-0-语法-flex-grow-shrink-basis" tabindex="-1"><a class="header-anchor" href="#实际上相当于是flex-1-1-0-语法-flex-grow-shrink-basis"><span>实际上相当于是flex：1 1 0 语法：flex：grow shrink basis；</span></a></h4><h4 id="这三个数字-分别对应三个属性-是一种简写方式-即-flex-grow-1-flex-shrink-1-flex-basis-0-grow-扩大-shrink-收缩-basis-基准值" tabindex="-1"><a class="header-anchor" href="#这三个数字-分别对应三个属性-是一种简写方式-即-flex-grow-1-flex-shrink-1-flex-basis-0-grow-扩大-shrink-收缩-basis-基准值"><span>这三个数字，分别对应三个属性，是一种简写方式，即：flex-grow: 1; flex-shrink: 1; flex-basis: 0% (grow：扩大 shrink：收缩 basis：基准值)</span></a></h4><ul><li>flex-grow 设置弹性项的生长系数 该值决定了容器中多余空间如何分配，该值越大，元素分配到的大小就越多 默认值：0</li><li>flex-shrink 设置弹性项的收缩系数 该值决定了容器空间不够时，如果减小弹性项的大小 该值越大，元素见效的大小就越多 -默认值：1</li><li>flex-basis-设置弹性项的主轴方向的基准大小 -默认值：auto</li></ul>',4),v={href:"https://juejin.cn/post/7339042131467747368",target:"_blank",rel:"noopener noreferrer"},m=a(`<h2 id="less、scss-等css-预处理器-和css" tabindex="-1"><a class="header-anchor" href="#less、scss-等css-预处理器-和css"><span>Less、Scss 等CSS 预处理器 和css</span></a></h2><div class="hint-container info"><p class="hint-container-title">css</p><ul><li>css 是一种标准的样式表语言。</li><li>优点： <ul><li>原生CSS，无需额外编译步骤。</li><li>浏览器原生支持，无需额外的依赖。</li></ul></li><li>缺点： <ul><li>缺乏一些高级功能，如变量、嵌套规则等，导致样式表冗长和重复。</li><li>难以维护和扩展，特别是对于大型项目</li></ul></li></ul></div><div class="hint-container info"><p class="hint-container-title">Less、Scss 等CSS 预处理器</p><p>Less和Sass是CSS的扩展，提供了更多的功能和特性，使样式表的编写更加灵活和高效。 Less和Sass都需要通过编译器将其转换为标准的CSS语法</p><ul><li><p>less 编写简单且简洁</p><ul><li>Less（Leaner Style Sheets）是一种向后兼容的 CSS 扩展，它允许开发者使用类似于编程的方式来编写 CSS。</li><li>Less 引入了变量、混合（类似于函数的结构）、嵌套规则等特性，极大地提高了代码的可重用性和可维护性。</li><li>它可以在客户端或服务器端（如 Node.js）运行，这为开发者提供了灵活的使用方式。</li></ul></li><li><p>scss 功能丰富且强大</p><ul><li>SCSS（Sassy CSS）是 Sass 的一个版本，它使用类似于 CSS 的语法，这意味着任何有效的 CSS 代码都是合法的 SCSS 代码。</li><li>SCSS 不仅保留了 Less 的所有优点，还增加了诸如条件语句、循环、函数等更高级的功能。</li><li>这使得 SCSS 在处理复杂项目时显得更加得心应手</li></ul></li></ul><div class="language-text line-numbers-mode" data-ext="text" data-title="text"><pre class="language-text"><code>- 相同点
